<template>
  <div class="wrapper landing-page">
    <div class="page-header page-header-small">
      <parallax class="page-header-image" style="background-image: url('img/bg26.jpg')"></parallax>
        ...
        <div class="row">
          <div class="col-md-4">
            <card type="testimonial">
              ...
              >The networking at Web Summit is like no other European tech conference.</p>
          ...
          <div class="col-md-4">
            <card type="testimonial">
              ...
              <p
                class="card-description"
              >Web Summit will increase your appetite, your inspiration, and your network.</p>
              <template slot="raw-content">
                <div class="icon icon-primary">
                  <i class="fas fa-quote-right"></i>
                </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <card type="pricing" plain>
                ...
                <n-button type="primary" round>Sign Up</n-button>
              </card>
            </div>
            <div class="col-md-4">
              <card
